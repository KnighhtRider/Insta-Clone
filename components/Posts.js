...
function Posts() {
  ...
  useEffect(() => {
    /* Fetch all posts */
    fetch("https://insta-clone-coral-three.vercel.app/createpost", {
      headers: {
  ...
  const likePost = (id) => {
    fetch("https://insta-clone-coral-three.vercel.app/like", {
      method: "put",
      headers: {
  ...
  const unlikePost = (id) => {
    fetch("https://insta-clone-coral-three.vercel.app/unlike", {
      method: "put",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + localStorage.getItem("jwt"),
  ...
  const makeComment = (text, id) => {
    fetch("https://insta-clone-coral-three.vercel.app/comment", {
      method: "put",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + localStorage.getItem("jwt"),
