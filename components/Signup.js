...
function Signup() {
  ...
  const postData = () => {
    ...
    fetch('https://insta-clone-coral-three.vercel.app/signup', {
      method:'post',
      headers:{
  ...
  return (
    <div classNameName="h-screen flex flex-row justify-center items-center">
      <div classNameName=" bg-gray-100 flex flex-col justify-center items-center lg:col-span-1">
        <div classNameName="bg-white border w-80 pt-8 flex items-center flex-col mb-3">
          ...
          <button className="mt-4 flex bg-blue-400 hover:bg-blue-500 text-white py-2 px-4 rounded w-64 justify-center">
            <div classNameName="bg-no-repeat facebook-logo mr-1 mt-1"></div>
            <span className='font-normal'>
              Log in with Facebook
            </span>
          </button>

          <div classNameName="flex justify-evenly space-x-2 w-64 mt-4">
          ...
          <div classNameName="mt-8 w-64 flex flex-col">
            <input
              autofocus
